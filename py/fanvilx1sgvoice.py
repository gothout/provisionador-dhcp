...
<sysConf>
    ...
    <net>
        ...
        <VendorClassID>Fanvil X1SG</VendorClassID>
    ...
    <mm>
        ...
        <ILBCPayloadLen></ILBCPayloadLen>
        <G726-16PayloadType></G726-16PayloadType>
        <G726-24PayloadType></G726-24PayloadType>
        <G726-32PayloadType></G726-32PayloadType>
        <G726-40PayloadType></G726-40PayloadType>
        ...
        <CallwaitingTone></CallwaitingTone>
        ...
        <capability>
            <AudioCodecSets>PCMU,PCMA,G726-16,G726-24,G726-32,G726-40,G729,iLBC,opus,G722</AudioCodecSets>
        </capability>
    </mm>
    <sip>
        ...
        <line index="1">
            ...
            <DisplayName>{ramal}</DisplayName>
            <SipName></SipName>
            <RegisterAddr>{servidor}</RegisterAddr>
            <RegisterPort>5060</RegisterPort>
            <RegisterUser>{ramal}</RegisterUser>
            <RegisterPswd>{senha}</RegisterPswd>
            ...
            <ProxyAddr>sbc-ac-access.voicemanager.cloud</ProxyAddr>
            <ProxyPort>5064</ProxyPort>
            <ProxyUser></ProxyUser>
            <ProxyPswd></ProxyPswd>
    ...
    <phone>
        ...
        <date>
            ...
            <SNTPServer>200.160.7.186</SNTPServer>
            <SecondSNTPServer>time.nist.gov</SecondSNTPServer>
            <TimeZone>-12</TimeZone>
            <TimeZoneName>UTC-3</TimeZoneName>
            <SNTPTimeout>60</SNTPTimeout>
            <DSTType>0</DSTType>
            <DSTLocation>3</DSTLocation>
    ...
    <tr069>
        ...
        <CPESerialNumber>00100400FV02001000000c383e37a153</CPESerialNumber>
